...
class Game:
    ...
    def update(self):
        ...
        for skin in self.snake:
            pg.draw.rect(self.display, GREEN2, pg.Rect(skin.x, skin.y, BLOCK_SIZE, BLOCK_SIZE))
            pg.draw.rect(self.display, GREEN2, pg.Rect(skin.x + 4, skin.y + 4, 12, 12))
        # Drawing food 
        pg.draw.rect(self.display, WHITE, pg.Rect(self.food.x, self.food.y, BLOCK_SIZE, BLOCK_SIZE))
